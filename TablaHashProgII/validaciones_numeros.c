...
.                                                                                                                                   .
.                                                                                                                                   .
.                           V A L I D A C I O N E S   D E   N U M E R O S   P A R A   A R B O L E S                                 .
.                                                                                                                                   .
.                                                                                                                                   .
------------------------------------------------------------------------------------------------------------------------------------*/
...
char *Ingresar_Numero_A_P(){
    ...
    char *Numero = (char *) calloc(12, sizeof(char));
    ...
    do{
        ...
        if(contador > 0){
            ...
            printf(" Ingrese el Numero positivo (signo ' * ' para no cargar el Nodo!): ");
        }
        ...
        if(longuitud == 1 && Numero[longuitud - 1] == '\n'){
            ...
            printf("\n Ingreso Invalido! No ha ingresado nada. Por Favor, Ingrese un NUMERO POSITIVO o el signo ' * '!\n");
            bandera = false;
        }

        if(longuitud == 2 && Numero[0] == '*' && Numero[1] == '\n'){
        ...
        if(longuitud == 11 && Numero[longuitud - 1] != '\n'){
            ...
            printf("\n Ingreso Excesivo! Debe ingresar un Numero con un maximo de 10 DIGITOS o el signo ' * '!\n");
            bandera = false;
        }
        ...
        if(bandera){
            ...
            if(Numero[0] == '0' && longuitud >= 2){
                ...
                printf("\n Ingreso Invalido!, El numero no puede empezar con ' 0 ' y estar seguido de mas digitos!\n");
                bandera = false;
            }
            ...
            for(int i = 0; i < longuitud; i++){
                ...
                if(!isdigit(Numero[i])){
                    ...
                    if(Numero[i] == '*'){
                        ...
                        printf("\n Ingreso Invalido! Si desea ingresar el signo ' * ' para omitir el ingreso del Nodo, debe hacerlo ingresandolo SOLO!\n");
                        bandera = false;
                        break;
                    }
                    else{
...
char *Ingresar_Numero_A_N(){
    ...
    bool bandera, valido;
    int longuitud, contador = 0;
    char *Numero = (char *) calloc(13, sizeof(char));
    ...
    do{
        ...
        if(contador > 0){
            ...
            system("pause"); system("cls");
            printf(" Ingrese el Numero Negativo (signo ' * ' para no cargar el Nodo!): ");
        }
        ...
        if(longuitud == 1 && Numero[longuitud - 1] == '\n'){
            ...
            printf("\n Ingreso Invalido! No ha ingresado nada. Por Favor, Ingrese un NUMERO NEGATIVO o el signo ' * '!\n");
            bandera = false;
        }
        ...
        if(longuitud == 2 && Numero[0] == '-' && Numero[longuitud - 1] == '\n'){
            ...
            printf("\n Ingreso Invalido! Para ingresar el NUMERO NEGATIVO, debe ingresar algun digito, que actualmente no cargo!\n");
            bandera = false;
        }
            ...
            for(int i = 0; i < longuitud; i++){
                ...
                if(!isdigit(Numero[i])){
                    ...
                    if(Numero[i] == '-' && i != 0){
                        ...
                        printf("\n Ingreso Invalido! El Numero NO PUEDE tener otra cosa que no sean DIGITOS, el signo ' - ' o el signo ' * '!\n");
                        bandera = false;
                        break;
                    }
                }
                ...
                if(i == 0 && Numero[i] != '-'){
                    ...
                    printf("\n Ingreso Invalido! Lo ingresado no es un NUMERO NEGATIVO, ya que el primer elemento no es el ' - '!\n");
                    bandera = false;
                    break;
                }
...
char *Ingresar_Numero_A_PN(){
    ...
    do{
        ...
        if(contador > 0){
            ...
            system("pause"); system("cls");
            printf(" Ingrese el Numero Negativo o Positivo (signo ' * ' para no cargar el Nodo!): ");
        }
        ...
        if(longuitud == 1 && Numero[longuitud - 1] == '\n'){
            ...
            printf("\n Ingreso Invalido! No ha ingresado nada. Por Favor, Ingrese un NUMERO NEGATIVO o POSITIVO o el signo ' * ' para no ingresar nada al Nodo!\n");
            bandera = false;
        }

        if(longuitud == 2 && Numero[0] == '-' && Numero[longuitud - 1] == '\n'){

            printf("\n Ingreso Invalido! para ingresar un NUMERO NEGATIVO debe ingresar un digito despues el signo ' - ', actualmente no ingreso nada despues del ' - '!");
            bandera = false;
        }
            ...
            for(int i = 0; i < longuitud; i++){
                ...
                if(!isdigit(Numero[i]) && Numero[i] != '\n'){
                    ...
                    //si es cualquier otra cosa a lo anterior mencionado, imprimo el cartel.
                        ...
                        printf("\n Ingreso Invalido! El Numero solo puede contener DIGITOS, el signo ' - ' o el signo ' * '!\n");
                        bandera = false;
                        break;
                    }
                }
